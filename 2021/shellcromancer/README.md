...
Source: https://twitter.com/shellcromancer/status/1477754625218514945
Description: Finding salsa20 crypto routines and constants
...
Source: https://twitter.com/shellcromancer/status/1478219112845393928
Description: Finding RC4 crypto
...
rule alg_crypto_rc4 {
    ...
    strings:
        // find upper limit in KSA 
        $ksa0 = { 3d 00 01 00 00 }        // cmp eax, 256
        $ksa1 = { 81 f? 00 01 00 00 }     // cmp {ebx, ecx, edx}, 256
        $ksa2 = { 48 3d 00 01 00 00 }     // cmp rax, 256
        $ksa3 = { 48 81 f? 00 01 00 00 }  // cmp {rbx, rcx, …}, 256
